  ...
  data: {
    ...
    items: {
      neko: {
        ...
        subname: "",
        name: "にゃん太郎さん",
        about: "にゃん太郎さんは村のみんなととても仲良しで、誰とでも打ち解けられる性格。冒険好きで、いつもパワフルに活動している。基本真面目で優しい。恋愛に対して鈍感な部分がある。ひよこさんと気が合い、いつも一緒にいる。",
        skill: "畑で野菜作り。運動",
      ...
      hiyoko: {
        ...
        subname: "",
        name: "ひよこさん",
        about: "にゃん太郎の親友。６匹のひよこの兄弟の中で２番目に上のお姉さん。にゃん太郎さんがなぜこんなに一緒にいてくれるかは謎だなぁと思いながら楽しいから基本的に一緒にいようと思って過ごしている。",
        skill: "存在を消す事。",
        hobby: "ひよこたちのおもり。",
        word: "今が幸せ",
